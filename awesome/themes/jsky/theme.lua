...
-- lain widgets icons
theme.cpu_icon      = config_dir .. "/icons/cpu.png"
theme.mem_icon      = config_dir .. "/icons/mem.png"
theme.fs_icon       = config_dir .. "/icons/fs.png"
theme.netup_icon    = config_dir .. "/icons/net_up.png"
